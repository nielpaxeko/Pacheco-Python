...
weather_df = pd.read_csv("notes/weather_data.csv")
...
student_df.to_csv("/Users/nielpaxeko/Desktop/Programming/Python/Pacheco-Python/Intermediate/Day25/notes/student_data.csv")